...
export const mockTriggeredAlerts: TriggeredAlert[] = [
  ...
  },
  {
    ...
    alertId: 'alert-001',
    alertName: 'High CPU Usage Alert',
    triggeredTimestamp: getRecentTimestamp(1, 11),
    resourceName: 'Web Server 01',
    service: 'VM',
    condition: 'greater-than',
    thresholdValue: 80,
  ...
  },
  {
    ...
    alertId: 'alert-001',
    alertName: 'High CPU Usage Alert',
    triggeredTimestamp: getRecentTimestamp(0, 2),
    resourceName: 'Microservices API Server',
    service: 'VM',
    condition: 'greater-than',
    thresholdValue: 80,
    metric: 'CPU Usage',
  ...
  },
  {
    ...
    alertId: 'alert-002',
    alertName: 'Low Memory Alert',
    triggeredTimestamp: getRecentTimestamp(1, 5),
    resourceName: 'Microservices API Server',
    service: 'VM',
    condition: 'less-than',
    thresholdValue: 10,
  ...
  },
  {
    ...
    alertId: 'alert-005',
    alertName: 'Disk I/O Warning',
    triggeredTimestamp: getRecentTimestamp(3, 4),
    resourceName: 'Microservices API Server',
    service: 'VM',
    condition: 'greater-than',
    thresholdValue: 100,
